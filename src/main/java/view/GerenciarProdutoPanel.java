 ...
 */
public class GerenciarProdutoPanel extends javax.swing.JPanel {

    DefaultListModel MODELO;
    List<Produto> produtos = new ArrayList<>();
    Integer [] ids;
    
    public GerenciarProdutoPanel() {
        initComponents();
    ...
    public void ListaDePesquisa() {
        try {
            ...
            produtos = iproduto.buscarProdutoPorNome(PesquisaNome.getText());

            MODELO.removeAllElements();
            ids = new Integer[produtos.size()];
            
            for (int i = 0; i < produtos.size(); i++) {
                Produto produto = produtos.get(i);
                MODELO.addElement(produto.getTipo_produto());
                ids[i] = produto.getId();
            }
            
            Lista.setVisible(!produtos.isEmpty());
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Buscar produto", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 24))); // NOI18N
        ...
        DataValidadeField.setFont(new java.awt.Font("Liberation Sans", 0, 18)); // NOI18N
        DataValidadeField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                DataValidadeFieldActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(nomeField, javax.swing.GroupLayout.DEFAULT_SIZE, 364, Short.MAX_VALUE)
                .addGap(18, 18, 18)
                .addComponent(jLabel4)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(DataValidadeField, javax.swing.GroupLayout.PREFERRED_SIZE, 168, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        excluirButton.setText("Desabilitar produto");
    ...
    private void excluirButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirButtonActionPerformed
        int indice = Lista.getSelectedIndex();
        if (indice >= 0) {
            int confirmacao = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja excluir este produto?", "Confirmação", JOptionPane.YES_NO_OPTION);
            if (confirmacao == JOptionPane.YES_OPTION) {
                try {
                    Registry registro = LocateRegistry.getRegistry("localhost", 1099);
                    InterfaceProduto iproduto = (InterfaceProduto) registro.lookup("Produto");
                    
                    iproduto.desativarProduto(ids[indice]);
    ...
    private void DataValidadeFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DataValidadeFieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_DataValidadeFieldActionPerformed
